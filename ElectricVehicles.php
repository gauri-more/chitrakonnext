               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index d-flex justify-content-between align-items-end">
                     <div class="breadcrumb__section-title-box">
                        <h3 class="breadcrumb__title">Electric Vehicles</h3>
                     </div>
...
<span class="tp-section-subtitle">Electric Vehicles</span>

<h3 class="mb-20">
    Reliable Wire Harness Solutions for Electric Vehicles
</h3>
...
<p>
    ...
    long-term performance.
            ...
            <div class="col-lg-6 text-center">
                <img src="assets/images/electrical-vehicle.jpg"
                     class="img-fluid rounded shadow"
                     alt="Electric vehicle wiring harness for battery and power systems" loading="lazy">
            </div>
      ...
      <div class="tp-blog-3-area pt-70 pb-90">
         ...
         <div class="tp-step-section-box text-center mb-50">
            ...
            Automotive, Electric Vehicles, Renewable Energy, Home Appliances,
