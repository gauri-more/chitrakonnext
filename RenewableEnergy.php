               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index d-flex justify-content-between align-items-end">
                     <div class="breadcrumb__section-title-box">
                        <h3 class="breadcrumb__title">Renewable Energy</h3>
                     </div>
...
<span class="tp-section-subtitle">Renewable Energy</span>

<h3 class="mb-20">
    Reliable Wire Harness Solutions for Renewable Energy Applications
</h3>
    ...
    quality inspection and electrical testing to ensure long service life and dependable field performance.
            ...
            <div class="col-lg-6 text-center">
                <img src="assets/images/solar-panel.jpg"
                     ...
                     alt="Renewable energy wiring harness for solar and power equipment" loading="lazy">
            </div>
