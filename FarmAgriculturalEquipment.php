               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index d-flex justify-content-between align-items-end">
                     <div class="breadcrumb__section-title-box">
                        <h3 class="breadcrumb__title">Farm & Agricultural Equipment</h3>
                     </div>
                     <div class="breadcrumb__list">
                        ...
                        <span class="dvdr"><i>/</i></span>
                        <span>Farm & Agricultural Equipment</span>
                     </div>
                  </div>
               </div>
            </div>
...
<span class="tp-section-subtitle">Farm & Agricultural Equipment</span>

<h3 class="mb-20">
    Reliable Wire Harness Solutions for Farm & Agricultural Equipment
</h3>
