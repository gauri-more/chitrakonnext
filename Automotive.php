               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index d-flex justify-content-between align-items-end">
                     <div class="breadcrumb__section-title-box">
                        <h3 class="breadcrumb__title">Automotive</h3>
                     </div>
...
<span class="tp-section-subtitle">Automotive</span>
...
<p>
    ...
    dependable, long-lasting performance on the road.
            ...
            <div class="col-lg-6 text-center">
                <img src="assets/images/automotive.jpeg"
                     class="img-fluid rounded shadow"
                     alt="Automotive wire harness assemblies for vehicle electrical systems" loading="lazy">
            </div>
